...
import static org.datagen.io.ConfigReader.readCfg;
...
public class PassportGenerator {
    ...
    ;
    private static final String OKATO;
    ...
    static {
        ...
        FEMALE_LAST_NAME = config.get("FEMALE_LAST_NAME");
        FEMALE_NAME = config.get("FEMALE_NAME");
        FEMALE_PATRONYMIC = config.get("FEMALE_PATRONYMIC");
        MALE_LAST_NAME = config.get("MALE_LAST_NAME");
        MALE_NAME = config.get("MALE_NAME");
        MALE_PATRONYMIC = config.get("MALE_PATRONYMIC");
        OKATO = config.get("MALE_PATRONYMIC");
    }
    ...
    private String getDataPoolFullPath(String name,LinkedHashMap<String,String> config){
        switch (name){
